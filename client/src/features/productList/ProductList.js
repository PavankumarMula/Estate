...
// static data for fiters suchg as category and Brand
const filters = [
  {
    id: "category",
    name: "Category",
...
export default function ProductList() {
  ...
  const filterHandler = (e, section, option) => {
    ...
    dispatch(fetchFilterdProductsAsync(newFilter));
  };

  const sortHandler = (e, optionObj) => {
    dispatch(fetchSortedProductsAsync(optionObj));
    setSortedData({ ...sortData, optionObj });
  };
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              <DesktopFilter handleFilter={filterHandler}></DesktopFilter>
              {/* Product grid */}
